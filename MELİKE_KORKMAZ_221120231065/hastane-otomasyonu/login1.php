...
<html lang="en">
  ...
  <body style="background: #F0F2F0;background: -webkit-linear-gradient(to bottom, #000C40, #F0F2F0);background: linear-gradient(to bottom, #000C40, #F0F2F0); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>Hastane Otomasyonu</h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> Biz sizin için buradayız!</h4>
          </div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
              <h3 style="margin-top: 10%">Hasta Girişi</h3><br>
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  <div class="col-md-4"><label>Mail: </label></div>
                  <div class="col-md-8"><input type="text" name="email" class="form-control" placeholder="Email" required/></div><br><br>
                  <div class="col-md-4" style="margin-top: 8%"><label>Şifre: </label></div>
